...
또한 위 이미지에서 IT에서 등장하는 태그를 클릭하는 경우 좌측 종합 차트에서 해당 키워드가 등장하는 게시글 빈도수를 필터링할 수 있습니다. 예를들어 카카오를 선택하는 경우 최근 라이온하트 인수와 카카오페이가 상장되어서 카카오페이와 오딘 등이 관련 키워드로 함께 등장합니다. 이런 방식으로 궁금한 키워드를 필터링하여 함께 등장하는 키워드를 확인할 수 있습니다. 
