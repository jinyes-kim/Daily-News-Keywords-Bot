...
아마도 서비스가 더욱 발전한다면 뉴스 기사의 본문까지 수집하고, 자주 등장하는 키워드를 기반으로 해당 키워드가 등장하는 뉴스 기사에서 본문의 핵심을 요약하는 서비스로 발전하는 방향을 생각해볼 수 있습니다. (아쉽게도 자연어처리에 대한 지식이 얕아서 아직 도전은 못해보고 있습니다.) 
